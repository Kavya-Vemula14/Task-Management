    ...
    <>
      <div className="bg-gradient-to-r from-green-400 to-blue-500 text-white py-20 px-4">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          ...
          {/* Subheading */}
          <p className="mt-4 text-xl text-center">Manage your Task</p>

          {/* Feature Icons */}
          <div className="flex space-x-8 mt-10">
            <div className="flex flex-col items-center">
              <FaMoneyBillWave className="text-3xl" />
              <p className="mt-2">Adding Task</p>
            </div>
            <div className="flex flex-col items-center">
              <FaFilter className="text-3xl" />
              <p className="mt-2">Updating Task</p>
            </div>
            <div className="flex flex-col items-center">
              <IoIosStats className="text-3xl" />
              <p className="mt-2">Deleting Task</p>
            </div>
          </div>
      ...
      <div className="py-20 px-4">
        ...
        <div className="mt-10 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p>Register and start managing your Task lists in a minute.</p>
          </div>
          {/* Step 2 */}
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="mb-2 font-semibold">Add Task</h3>
            <p>Quickly add your task with title and description.</p>
          </div>
          {/* Step 3 */}
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="mb-2 font-semibold">View update delete</h3>
            <p>
              {" "}
              View the added tasklist update the individual task list and
              description and delete them{" "}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-100 py-20 px-4">
        ...
        <div className="mt-10 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <FaQuoteLeft className="text-xl text-gray-400" />
            <p className="mt-4">
              "Finally, a hassle-free way to manage my Task. The insights
      ...
      <div className="bg-blue-500 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold">
            Ready to Take Control of Your Task?
          </h2>
